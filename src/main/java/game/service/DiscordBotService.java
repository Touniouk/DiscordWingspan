...
public class DiscordBotService {
    ...
    public Game getGameFromId(SlashCommandInteractionEvent event, String gameId) throws GameInputException {
        Game currentGame = GameService.getInstance().getActiveGames().get(gameId);
        if (currentGame == null) {
